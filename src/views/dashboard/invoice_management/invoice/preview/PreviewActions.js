  ...
  return (
    <Card className='invoice-action-wrapper'>
      <CardBody>
        ...
        <Button color='secondary' tag={Link} to='/dashboard/invoice_management/invoice/print' target='_blank' block outline className='mb-75'>
          Print
        </Button>
        <Button tag={Link} to={`/dashboard/invoice_management/invoice/edit/${id}`} color='secondary' block outline className='mb-75'>
          Edit
        </Button>
