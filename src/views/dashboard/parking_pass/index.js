...
const index = () => {
  ...
  async function fetchTableData() {
    try {
      setLoading(true);
      const { data } = await useJwt.getAll();
      const { content } = data;
  ...
  const columns = [
...

    {
      ...
      sortable: true,
      // minWidth: "150px",
      selector: (row) => row.parkingName,
    },
    {
      name: "Amount",
      sortable: true,
      // minWidth: "150px",
      selector: (row) => row.parkingAmount,
    },

    {
      ...
      sortable: true,
      // minWidth: "150px",
      selector: (row) => row.perDayDueChargesType,
    },
    {
      name: "Over Due Charges",
      sortable: true,
      // minWidth: "150px",
      selector: (row) => row.perDayDueChargesAmount,
    },
