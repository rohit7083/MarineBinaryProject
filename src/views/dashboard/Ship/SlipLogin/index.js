...
// // ** Third Party Imports
// import { useForm, Controller } from 'react-hook-form'  // <-- Add this import
// import illustrationsLight from '@src/assets/images/pages/login-v2.svg'
// import illustrationsDark from '@src/assets/images/pages/login-v2-dark.svg'
...
//   // ** Hooks
//   const { skin } = useSkin()
//   const dispatch = useDispatch()  // Use the dispatch hook here
//   const navigate = useNavigate()
//   const ability = useContext(AbilityContext)
//   const {
//     control,
...
//   // Updated onSubmit function that integrates the API
//   const onSubmit = (data) => {
//     if (Object.values(data).every(field => field.length > 0)) {
...
//         })
//         .then(data => {
//           // If login was successful, print success message to the console
...
//               Login 👋
//             </CardTitle>
//             <CardText className='mb-2'>Login Kar bhai login</CardText>
//             <Form className='auth-login-form mt-2' onSubmit={handleSubmit(onSubmit)}>
//               <div className='mb-1'>
//                 <Label className='form-label' for='login-email'>
//                   Email
...
const Login = () => {
  ...
  // Updated onSubmit function that integrates the API and redirects on success
  const onSubmit = (data) => {
    if (Object.values(data).every(field => field.length > 0)) {
      fetch('http://192.168.29.190:8001/auth/login', {
        method: 'POST',
        ...
        .then(data => {
          ...
          navigate('/dashboard/SlipCategory');  // Change '/dashboard' to the route you want to redirect to
        })
        .catch(error => {
