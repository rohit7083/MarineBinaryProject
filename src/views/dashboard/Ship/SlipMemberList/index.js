...
// // ** Table Columns
// import { serverSideColumns } from '../../../tables/data-tables/data'

// // ** Store & Actions
// import { getData } from '../../../tables/data-tables/store'
...
//           <CardTitle tag='h4'>Slip List</CardTitle>
//         </CardHeader>
...
const DataTableServerSide = () => {
  ...
  return (
    <Fragment>
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">Slip Member Form</CardTitle>
          <Link to="/dashboard/SlipMemberForm">
            <Button.Ripple color="success">Add Vessels +</Button.Ripple>
          </Link>
        </CardHeader>
        <Row className="mx-0 mt-1 mb-50">
          <Col sm="6">
