...
//                     Password
//                   </Label>
//                   <Link to='/dashboard/UserAuth/forgetPass'>
...
//               <Link to='/dashboard/UserAuth/Registeruser'>  
...
//                 <Link to='/dashboard/UserAuth/emailOTP'>
//                 <Facebook size={14} />
//                 </Link>
//               </Button>
...
const Login = () => {
  ...
  const validatePassword = value => {
    return value.length === 0 ? "Password is required" : value.length < 6 ? "Password must be at least 6 characters" : true
  }

  const onSubmit = data => {
    console.log("Submit data", data)
    // Call your login API or dispatch login action
  }
